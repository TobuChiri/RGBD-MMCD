...
parser.add_argument("--single-backbone", action="store_true", help="测试单backbone版本")
...
cfg = getattr(import_module(config_path), "C")

# 设置单/双backbone模式
if args.single_backbone:
    os.environ['DFORMER_SINGLE_BACKBONE'] = '1'
    print("🚀 测试模式: 单backbone版本")
else:
    os.environ['DFORMER_SINGLE_BACKBONE'] = '0'
    print("🚀 测试模式: 双backbone版本（默认）")
